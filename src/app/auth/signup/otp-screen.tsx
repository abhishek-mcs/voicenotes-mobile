...
import {ActivityIndicator, Alert,Dimensions,Platform,StyleSheet,Text,TouchableHighlight,View,} from "react-native"
...
export default ()=>{
  ...
  return (
    <View style={styles.contentContainer}>
      ...
      <TouchableHighlight onPress={continueDeletion} style={[styles.continueBtn,{opacity:otpText?.indexOf('-')!=-1 ? 0.5 : 1,backgroundColor:Colors.primary}]} disabled={otpText?.indexOf('-')!=-1} underlayColor={Colors.primaryWithOpacity(0.8)}>
        {signup?.isLoading?
...
const styles=StyleSheet.create({
  ...
  contentContainer:{flex:1,backgroundColor:'#f8f8f8',paddingHorizontal:16,paddingBottom:16},
  ...
  continueBtn:{alignSelf:'center',backgroundColor:'#fd0',marginVertical:32,position:'absolute',bottom:0,width:'100%',borderRadius:100,height:49},
  continueBtnText:{color:'#222',fontFamily:'SF Pro-Bold',fontSize:16,lineHeight:19.2},
  title:{fontSize:24,fontFamily:'SF Pro-Medium',color:'#222',textAlign:'center',marginBottom:16},
  checkBoxStyle:{minHeight:32, marginBottom:16},
  checkboxLabel:{alignSelf:'center',color:'#222',fontSize:14,lineHeight:22,fontFamily:'SF Pro',flex:1,marginLeft:6},
  textInput:{paddingTop:13,paddingBottom:13,paddingHorizontal:16,backgroundColor:'rgba(240, 240, 240, 1)',borderWidth:0,borderRadius:12,marginTop:20,fontSize:14,fontFamily:'SF Pro-Medium',lineHeight:19,color:'#222',textAlignVertical:'top'},
  otpDesc:{color:'#000',fontSize:14,fontFamily:'SF Pro',lineHeight:21,textAlign:'center'},
  feedBackTitle:{marginTop:20,fontFamily:'SF Pro-Semibold',fontSize:16,lineHeight:22}
})