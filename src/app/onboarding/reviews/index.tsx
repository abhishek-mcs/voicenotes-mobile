...
const Reviews = () => {
    ...
    const reviews = [
        ...
        {
            id: 3,
            profileImage: <Image source={{ uri: "https://voicenotesbucket.s3.us-west-2.amazonaws.com/files/pictures/tweets/profile-pics/QzXoqT3fijpDKYaCtZ8uTOXmpvLwgJa4vNr0hTP5.jpg" }} style={styles.profileImage} />,
            name: "Product Hunt",
            rating: 5,
        ...
        {
            id: 4,
            profileImage: <Image source={{ uri: "https://voicenotesbucket.s3.us-west-2.amazonaws.com/files/pictures/tweets/profile-pics/6TiYjylwjn4KzDuBCwhiObRXDWlfzmvnqcZNB5kE.png"}} style={styles.profileImage} />,
            name: "Jordan Moore",
            rating: 5,
            review: "Honestly, one of the best value investments I've made this year. Voicenotes found its way into my daily routine immediately after first use and I mashed the lifetime button. \nKeep up the amazing work and keep walking that good balance between features and simplicity 🙏",
        },
        {
            id: 5,
            profileImage: <Image source={{ uri: "https://voicenotesbucket.s3.us-west-2.amazonaws.com/files/pictures/tweets/profile-pics/LdHdfOMTeyOSkyER4sjw0Lzleg4qB8w002UREy4y.jpg" }} style={styles.profileImage} />,
            name: "John Pierson",
            rating: 5,
            review: "Holy. Smokes. With all the AI talk these days I’ve wanted something like this. \nDownloaded the app, tried the free 1 minute notes for a few things and immediately bought the lifetime. \nReally awesome stuff!",
        },
        {
            id: 6,
            profileImage: <Image source={{ uri: "https://voicenotesbucket.s3.us-west-2.amazonaws.com/files/pictures/tweets/profile-pics/ZCvaPVQJ5xKMPfCGWP8g9q4uG4ouNIYBkBj0lXti.jpg" }} style={styles.profileImage} />,
            name: "Lovish Saini",
            rating: 5,
            review: "Since I migrated from traditional notes apps to quick voice notes I literally havn't looked back.\nVoice notes for quick, on the move notes and transcription of unrefined thoughts. Text notes for research and curation.",
        },
        {
            id: 7,
            profileImage: <Image source={{ uri: "https://voicenotesbucket.s3.us-west-2.amazonaws.com/files/pictures/tweets/profile-pics/3oaWLphBfVPtRJ1x0h0Dbx954p7iXGRSJuHa6AwV.jpg" }} style={styles.profileImage} />,
            name: "Omar Lari",
            rating: 5,
            review: "I recently installed @voicenotesai on my iPhone. So far the experience is awesome! helps a lot with organizing my tasks by taking relevant voice notes accompanied by the AI assistant which instantly summarizes the notes and assigns a title to the note automatically. Awesome!",
        },
        {
            id: 8,
        ...
        {
            id: 9,
            profileImage: <Image source={{ uri: "https://voicenotesbucket.s3.us-west-2.amazonaws.com/files/pictures/tweets/profile-pics/Rwk9vMX5XWhU80mM8WR00uHVVh7PUjtuiRiOlPUD.jpg" }} style={styles.profileImage} />,
            name: "Marc Littlemore",
            rating: 5,
            review: "One of the few new apps I’ve put on my phone over the past few years. I’m using it as a journaling tool at the moment and it’s helping me to dig into what makes me happy. It’s really easy to use and you should give it a try. Thanks @voicenotesai!",
        },
    ];
