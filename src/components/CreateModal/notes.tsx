...
export default (
    ...
    return (
        <View style={box}>
            ...
            <ScrollView style={{maxHeight:'80%',marginBottom:20,position:'relative',overflow:'hidden'}} contentContainerStyle={{paddingHorizontal:32}} showsVerticalScrollIndicator={false}>
