    ...
    return (
          ...
          <View style={{padding:16,backgroundColor:Colors.whiteWithOpacity(1),borderRadius:12,shadowColor:'rgba(0,0,0,0.5)'}}>
            ...
            :<View style={{width:screenWidth/1.2}}>
              ...
              <Text style={{fontSize:14,fontFamily:'Primary-Semibold',color:Colors.darkWithOpacity(1),lineHeight:19.2,marginLeft:8}}>
                Your shareable link is ready 
              </Text>
              </View>
              <Text style={{fontSize:14,fontFamily:'Primary',color:Colors.primary,textDecorationLine:'underline',marginTop:4}}>
              {MAIN_URL+'/s/'+slug}
              </Text>
